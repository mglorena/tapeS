/**
 * @class Ext.ux.grid.PrinterLicencias
 ...
 * Ext.require([
 *   'Ext.ux.grid.GridPrinterLicencias',
 * ]);
 * 
 * 2 - Declare the Grid 
 ...
 * 
 * 3 - Print!
 * Ext.ux.grid.PrinterLicencias.mainTitle = 'Your Title here'; //optional
...
Ext.define("Ext.ux.grid.PrinterLicencias", {
    ...
    statics: {
        ...
        print: function (grid) {
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('Ext.ux.grid.PrinterLicencias');
                this.stylesheetPath = scriptPath.substring(0, scriptPath.indexOf('PrinterLicencias.js')) + 'gridPrinterCss/printlicense.css';
            }
