/**
 * @class Ext.ux.grid.PrinterServicios
 ...
 * 
 * 3 - Print!
 * Ext.ux.grid.PrinterServicios.mainTitle = 'Your Title here'; //optional
...
Ext.define("Ext.ux.grid.PrinterServicios", {
    ...
    statics: {
        ...
        print: function(grid) {
           ...
           columns.length = columns.length -1; // elimino la column Paga
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('Ext.ux.grid.PrinterServicios');
                this.stylesheetPath = scriptPath.substring(0, scriptPath.indexOf('PrinterServicios.js')) + 'gridPrinterCss/print.css';
            }
            ...
            var htmlMarkup = [
                ...
                '</table>',
                '{% } else { %}',
                '<br/><div class="' + Ext.baseCSSPrefix + 'ux-grid-printer-header">' + this.headerText + '</div>',
                '<div style="padding-bottom:0px" class="' + Ext.baseCSSPrefix + 'ux-grid-printer-bodyTitle">' + this.mainTitle + '</div>',
                this.headerEmerald,
                '<table style="margin-bottom:5px;">',
                '<tr>',
        ...
        bodyTpl: [
            ...
            '<td  style="{[values.dataIndex === "Usuario" ? "width:220px;text-align:" : "width:80px;text-align:"]}{[Ext.String.createVarName(values.align)]}">\{{[Ext.String.createVarName(values.dataIndex)]}\}</td>',
            '<tpl else>',
