/**
 * @class Ext.ux.grid.PrinterReportAnual
 ...
 * Ext.require([
 *   'Ext.ux.grid.GridPrinterReportAnual',
 * ]);
 * 
 * 2 - Declare the Grid 
 ...
 * 
 * 3 - Print!
 * Ext.ux.grid.PrinterReportAnual.mainTitle = 'Your Title here'; //optional
...
Ext.define("Ext.ux.grid.PrinterReportAnual", {
    ...
    statics: {
        ...
        print: function(grid) {
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('Ext.ux.grid.PrinterReportAnual');
                this.stylesheetPath = scriptPath.substring(0, scriptPath.indexOf('PrinterReportAnual.js')) + 'gridPrinterCss/print.css';
            }
            ...
            var htmlMarkup = [
                ...
                '<div class="' + Ext.baseCSSPrefix + 'ux-grid-printer-bodyTitle" style="align:center">' + this.mainTitle + '<br/></div>',
                '<table>',
                '<tr>',
                headings,
                '</tr>',
         ...
         * @type String
         * The path at which the print stylesheet can be found (defaults to 'ux/grid/gridPrinterReportAnualCss/print.css')
         */
        stylesheetPath: null,
        /**
