 ...
 * 
 * 3 - Print!
 * Ext.ux.grid.PrinterAuto.mainTitle = 'Your Title here'; //optional
...
Ext.define("Ext.ux.grid.PrinterAuto", {
    ...
    statics: {
        ...
        print: function(grid) {
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('Ext.ux.grid.PrinterAuto');
                this.stylesheetPath = scriptPath.substring(0, scriptPath.indexOf('PrinterAuto.js')) + 'gridPrinterCss/print.css';
            }
...
//            '</div>',
//            this.marginExpte,
//            '<div class="' + Ext.baseCSSPrefix + 'ux-grid-printer-header">' + this.headerText + 'Prueba texto<br/></div>',
//            '<div class="' + Ext.baseCSSPrefix + 'ux-grid-printer-bodyTitle">' + this.mainTitle + '<br/></div>',
//            '<table>',
//            '<tr>',
//            headings,
//            '</tr>',
...
//        
        ...
        '<tpl for=".">',
        '<tpl if="values.dataIndex">',
        '<td  style="{["text-align:"]}{[Ext.String.createVarName(values.align)]}{[";font-size:9px"]}">\{{[Ext.String.createVarName(values.dataIndex)]}\}</td>',
        //'<td  style="{[values.dataIndex === "Centro" ? "width:220px;text-align:" : "width:90px;text-align:"]}{[Ext.String.createVarName(values.align)]}">\{{[Ext.String.createVarName(values.dataIndex)]}\}</td>',
        '<tpl else>',
        '<td  style="{["text-align:"]}{[Ext.String.createVarName(values.align)]}{[";font-size:9px"]}">\{{[Ext.String.createVarName(values.id)]}\}</td>', 
        '</tpl>',   
        '</tpl>'
        ]
    }
