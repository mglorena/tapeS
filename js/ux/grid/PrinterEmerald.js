/**
 * @class Ext.ux.grid.PrinterEmerald
 ...
 * 
 * 3 - Print!
 * Ext.ux.grid.PrinterEmerald.mainTitle = 'Your Title here'; //optional
...
Ext.define("Ext.ux.grid.PrinterEmerald", {
    ...
    statics: {
        ...
        print: function(grid) {
            ...
            columns.length = columns.length -2 ;
            var data = [];
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('Ext.ux.grid.PrinterEmerald');
                this.stylesheetPath = scriptPath.substring(0, scriptPath.indexOf('PrinterEmerald.js')) + 'gridPrinterCss/print.css';
            }
        ...
        '<td  style="{"width:"}{[values.width ? values.width : "90"]}{["px;text-align:"]}{[Ext.String.createVarName(values.align)]}">\{{[Ext.String.createVarName(values.dataIndex)]}\}</td>',
