...
x_LoadPrestamos(dia, mes, anio, tvehiculoId, estado, LoadPrestamos_callback);
...
function GetChVe(evt)
{
    try
    {
        ...
        var reId = Ext.getCmp('txtPrestamoId').getValue();
    ...
    {
        SendJsError(e, "GetChVe - Prestamos.js", evt);
    }
}
...
function GetDisponibles_callback(response)
{
    ...
    {
        SendJsError(e, "GetDisponibles_callback - Prestamos.js", response);
    }
...
function FormField(record)
{
    ...
    try
    {
        ...
        if (record)
        {
            ...
            var resId = record.data['PrestamoId'];
        ...
        formFields = [
            {
                ...
                id: 'txtPrestamoId',
                name: 'PrestamoId',
                value: (record ? record.data['PrestamoId'] : null),
                editable: false
            },
            {
    ...
    {
        SendJsError(e, "FormField - Prestamos.js", formFields);
    }
}
...
function FechaCompleta(cfecha) {
    ...
    {
        SendJsError(e, "FechaCompleta - Prestamos.js", cfecha);
    }
}
...
function FieldsCosto()
{
    ...
    {
        SendJsError(e, "FechaCompleta - Prestamos.js", "formFields");
    }
}
...
function GetValorHora(obj)
{
    ...
    {
        SendJsError(e, "GetValorHora - Prestamos.js", obj);
    }
}
...
function CostoTotal()
{
    ...
    {
        SendJsError(e, "CostoTotal - Prestamos.js", "obj");
    }
}
...
function ImprimirCosto()
{
    ...
    {
        SendJsError(e, "ImprimirCosto - Prestamos.js", html);
    }
}
...
function PopinCosto(res)
{
    ...
    {
        SendJsError(e, "PopinCosto - Prestamos.js", res);
    }
}
...
function InfoPresupuesto_callback(response)
{
    ...
    {
        SendJsError(e, "Prestamos.js", response);
    }
...
function PopinPrestamo(action, record)
{
    try
    {
        ...
        if (action === "add") {
            ...
            title = "Editar Prestamo : " + (record ? record.data['Solicitante'] + " - " + record.data['Destino'] : '');
    ...
    {
        SendJsError(e, "PopinPrestamo - Prestamos.js", action);
    }
}
function GridPanel(store, tve)
{
    ...
    try
    {
        ...
        grid = Ext.create('Ext.grid.Panel', {
                    ...
                    items: [{
                            ...
                            handler: function(grid, rowIndex, colIndex) {
                                if (hasUpdate) {
                                    ...
                                    DeletePrestamo(record, grid, rowIndex);
                                }
                            ...
                            handler: function(grid, rowIndex, colIndex) {
                                if (hasUpdate) {
                                    ...
                                    win.show();
                                    ridx = rowIndex;
                                    x_InfoPresupuesto((record ? record.data['PrestamoId'] : null), InfoPresupuesto_callback);
                                }
                            ...
                            handler: function(grid, rowIndex, colIndex) {
                                if (hasUpdate) {
                                    var record = grid.store.getAt(rowIndex);
                                    var win = PopinUpload((record ? record.data['PrestamoId'] : null));
                                    win.show();
                                    ridx = rowIndex;
                                }
                        ...
                        , {
                            ...
                            handler: function(grid, rowIndex, colIndex) {
                                var record = grid.store.getAt(rowIndex);
                                if (hasUpdate) {
                                    var win = PopinPrestamo('edit', record);
                                    win.show();
                                    ridx = rowIndex;
                                    GetChVe("");
                                }
            ...
            renderTo: 'tblPrestamos',
            width: 900,
            height: 457,
            //stripeRows: true,
            title: 'Prestamos - Automotores UNSa',
            frame: true,
            tbar: [{
                    xtype: 'datefield',
                    fieldLabel: 'Dia',
                ...
                , {
                    ...
                    handler: function() {
                        if (hasInsert) {
                            ...
                            var record = null;
                            var win = PopinPrestamo('add', record);
                            win.show();
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        Ext.ux.grid.Printer.mainTitle = "Lista de Prestamos <br/> Mes: " + mesn + "    Año : " + anio;
    ...
    {
        SendJsError(e, "PopinPrestamo - Prestamos.js", anios);
    }
}
function LoadPrestamos_callback(response)
{
    var data;
    try
    {
        ...
        Ext.onReady(function() {
            ...
            Ext.define('Prestamo', {
                ...
                fields: ['PrestamoId', 'Destino', 'Solicitante', 'EmailSolicitante', 'AutorizadoPor', 'Tipo', 'Vehiculo', 'VehiculoId', 'ChoferesIds',
    ...
    {
        SendJsError(e, "LoadPrestamos_callback - Prestamos.js", data);
    }
}
var rowDelete;
function DeletePrestamo(record, grid, rowId)
{
    try
    {
        if (hasUpdate) {
            rowDelete = rowId;
            Ext.Msg.confirm('Eliminar Prestamo', 'Esta seguro que quiere eliminar este Prestamo?', function(button) {
                if (button === 'yes') {
                    ...
                    if (rowDelete)
                    {
                        ...
                        var vehiculoId = record.data['PrestamoId'];
                        x_DeletePrestamo(vehiculoId, DeletePrestamo_callback);
                        rowDelete = null;
                    }
                }
            });
    ...
    {
        SendJsError(e, "DeletePrestamo - Prestamos.js", rowId);
    }
}
function DeletePrestamo_callback(response)
{
    ...
    else
    {
        ...
        SendJsError(new Error("Error DeletePrestamo-vehiculos.js"), "vehiculos.js", response);

    }

}
function SavePrestamo(form, action)
{
    var rec;
    try
    {
        ...
        if (action !== "add") {
            ...
            rec['PrestamoId'] = CurrentObject.data['PrestamoId'];
        }
        else
            rec['PrestamoId'] = 0;
        rec['UserId'] = user;
        var Prestamo = JSON.stringify(rec);
        //console.log(Prestamo);
        x_SavePrestamo(Prestamo, SavePrestamo_callback);
    } catch (e)
    {
        SendJsError(e, "SavePrestamo - Prestamos.js", rec);
    }
}


function SavePrestamo_callback(response)
{
    if (response)
    {
        humane.success("Se ha guardado la Prestamo correctamente.");
        x_LoadPrestamos(dia, mes, anio, tvehiculoId, estado, LoadPrestamos_callback);
    }
    else
    {
        humane.error("Hubo un error al guardar la Prestamo.");
        SendJsError(new Error("Error SavePrestamo-Prestamos.js"), "Prestamos.js", response);
    }
...
function GrabarCosto_callback(response)
{
    ...
    else
    {
        ...
        SendJsError(new Error("GrabarCosto_callback-Prestamos.js"), "Prestamos.js", response);
    }
}