...
class Expediente {
    ...
    function Guardar() {
        ...
        try {
            ...
            $query = "call proveedores_update(" . $this->ExpedienteId . "," . $this->RazonSocial . ",
    ...
    function Search() {
        ...
        try {
            ...
            $query = "call proveedores_search(" . $this->ExpedienteId . ",'" . $this->RazonSocial . "','" . $this->Rubros . "','" . $this->Domicilio . "');";
    ...
    function GetByExpedienteId($anio) {
        $proveedores = array();
        $query = "";
        try {
            $db = new sqlprovider();
            $db->getInstance();
            $query = "call proveedores_getById(" . $this->ExpedienteId . "," . $anio . ");";
            if ($db->setQuery($query)) {
                $proveedores = $db->ListObject();
            }
            $db->CloseMysql();
    ...
    function Delete() {
        ...
        $query = "";
        try {
            $query .="call proveedores_delete(" . $this->ExpedienteId . ");";
            $db = new sqlprovider();
            $db->getInstance();
            $db->setQuery($query);
            $result = $db->execute();
