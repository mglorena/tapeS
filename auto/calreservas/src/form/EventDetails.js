...
Ext.define('Ext.calendar.form.EventDetails', {
    ...
    requires: [
        ...
        'Ext.calendar.form.field.ChoferCombo',
    ...
    initComponent: function() {
        ...
        this.ChoferField = new Ext.calendar.form.field.ChoferCombo({
            name: 'Chofer',
            anchor: '70%'
        });
        ...
        this.urlField = new Ext.form.Text({
            ...
            name: Ext.calendar.data.EventMappings.Solicitante.name,
            anchor: '100%'
        });

        var leftFields = [this.titleField, this.dateRangeField, this.ChoferField],
